...
Result Analysis: My results show that for insertion takes the longest to run, especially as the dataset gets larger. For the reversed list insertion, search, and deletion all increased significantly in run time as the lists got longer.
